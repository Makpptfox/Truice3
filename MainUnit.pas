...
const
  ...
  PFX_QUEST_TEMPLATE_ADDON			= 'qa';
  PFX_QUEST_DETAILS					= 'qd';
  PFX_QUEST_REQUEST_ITEM			= 'qi';
  PFX_QUEST_OFFER_REWARD			= 'qo';
...
type
  ...
  published
    ...
    edqtId: TJvComboEdit;
    edqaPrevQuestId: TJvComboEdit;
    edqaNextQuestId: TJvComboEdit;
    edqaExclusiveGroup: TLabeledEdit;
	// NextQuestIdChain introuvable dans la table ? Remplacement par un doublon.
    edqaNextQuestId: TJvComboEdit;
    ...
    edqoRewardText: TMemo;
    edqiCompletionText: TMemo;
    edqtAreaDescription: TMemo;
	...
	// Le RequiredSpellCast ne semble plus exister. Doublon pour éviter les err.
    edqtItemDrop1: TJvComboEdit;
    edqtItemDrop2: TJvComboEdit;
    edqtItemDrop3: TJvComboEdit;
    edqtItemDrop4: TJvComboEdit;
    ...
    edqiEmoteOnIncomplete: TJvComboEdit;
    edqiEmoteOnComplete: TJvComboEdit;
    edqdEmote1: TJvComboEdit;
    edqdEmote2: TJvComboEdit;
    edqdEmote3: TJvComboEdit;
    edqdEmote4: TJvComboEdit;
    edqoEmote1: TJvComboEdit;
    edqoEmote2: TJvComboEdit;
    edqoEmote3: TJvComboEdit;
    edqoEmote4: TJvComboEdit;
    edqdEmoteDelay1: TLabeledEdit;
    edqdEmoteDelay2: TLabeledEdit;
    edqdEmoteDelay3: TLabeledEdit;
    edqdEmoteDelay4: TLabeledEdit;
    edqoEmoteDelay1: TLabeledEdit;
    edqoEmoteDelay2: TLabeledEdit;
    edqoEmoteDelay3: TLabeledEdit;
    edqoEmoteDelay4: TLabeledEdit;
    gbAreatrigger: TGroupBox;
    lbAreatrigger: TLabel;
	//Areatrigger ne semble plus exister non plus. Doublon pour éviter err.
    edqtUnknow0: TJvComboEdit;
    edqaRequiredMaxRepFaction: TJvComboEdit;
    edqaRequiredMaxRepValue: TLabeledEdit;
	edqtQuestLevel: TLabeledEdit;
    edqtMinLevel: TLabeledEdit;
    edqaMaxLevel: TLabeledEdit;
    edqaRequiredSkillPoints: TLabeledEdit;
	edqaSpecialFlags: TJvComboEdit;
    ...
    edqtRewardDisplaySpell: TJvComboEdit;
    ...
    edqaRewardMailTemplateId: TLabeledEdit;
    edqaRewardMailDelay: TLabeledEdit;
    rbqtQuestSort: TRadioButton;
    rbqtZoneID: TRadioButton;
    edqtRewardHonor: TLabeledEdit;
    edqtQuestType: TLabeledEdit;
	...
	// RewardKillHonor = RewardHonorMultiplier ?
    ...
    edqaAllowableClasses: TJvComboEdit;
